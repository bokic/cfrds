...
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_filesscanned_item_result(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_filesscanned_item_filename(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS int cfrds_security_analyzer_result_filesnotscanned_count(const cfrds_security_analyzer_result *value);
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_filesnotscanned_item_reason(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_filesnotscanned_item_filename(const cfrds_security_analyzer_result *value, int ndx);
...
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_files_value(const cfrds_security_analyzer_result *value, int ndx);
...
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_errors_item_errormessage(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS int cfrds_security_analyzer_result_errors_item_endline(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_errors_item_path(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_errors_item_vulnerablecode(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_errors_item_filename(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS int cfrds_security_analyzer_result_errors_item_beginline(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS int cfrds_security_analyzer_result_errors_item_column(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_errors_item_error(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS int cfrds_security_analyzer_result_errors_item_begincolumn(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_errors_item_type(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS int cfrds_security_analyzer_result_errors_item_endcolumn(const cfrds_security_analyzer_result *value, int ndx);
EXPORT_CFRDS cfrds_str cfrds_security_analyzer_result_errors_item_referencetype(const cfrds_security_analyzer_result *value, int ndx);
...
EXPORT_CFRDS const char *cfrds_adminapi_customtagpaths_at(const cfrds_adminapi_customtagpaths *buf, int ndx);
